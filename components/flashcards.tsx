...
export function Flashcards({
  ...
  if (flashcards.length === 0) {
    return (
      <div className="flex h-[780px] flex-col items-center justify-center">
  ...
  return (
    <div className="flex h-[780px] flex-col items-center justify-center gap-8">
      ...
      <div className="perspective-1000">
        <Card
          className="w-[400px] h-[300px] cursor-pointer transition-transform duration-500"
          style={{
        ...
        >
          <div className="absolute w-full h-full backface-hidden">
            <CardContent className="flex items-center justify-center h-full p-4 text-2xl">
